const CACHE_NAME = 'hapcapex-v40-0-80-table-totals-pdf-chart-values-20260910';
const APP_SHELL = [
  './',
  './index.html',
  './controle-capex.html',
  ...
  './v40-control-managerial.js?v=40.0.80',
...
const CONTROL_MANAGERIAL_TAG = '<script src="./v40-control-managerial.js?v=40.0.80"></script>';
