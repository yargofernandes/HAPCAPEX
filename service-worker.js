const CACHE_NAME = 'hapcapex-v40-0-79-capex-compare-20260910';
const APP_SHELL = [
  './',
  './index.html',
  './controle-capex.html',
  ...
  './v40-control-managerial.js?v=40.0.79',
...
const CONTROL_MANAGERIAL_TAG = '<script src="./v40-control-managerial.js?v=40.0.79"></script>';
