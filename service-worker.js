const CACHE_NAME = 'hapcapex-v40-0-77-gerencial-exclusoes-20260909';
const APP_SHELL = [
  './',
  './index.html',
  './controle-capex.html',
  ...
  './v40-control-managerial.js?v=40.0.77',
...
const CONTROL_MANAGERIAL_TAG = '<script src="./v40-control-managerial.js?v=40.0.77"></script>';
