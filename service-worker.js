const CACHE_NAME = 'hapcapex-v40-0-78-gerencial-table-filters-net-routes-20260909';
const APP_SHELL = [
  './',
  './index.html',
  './controle-capex.html',
  ...
  './v40-control-managerial.js?v=40.0.78',
...
const CONTROL_MANAGERIAL_TAG = '<script src="./v40-control-managerial.js?v=40.0.78"></script>';
...
async function decorateBootstrapResponse(response) {
  ...
  return responseWithText(response, text, 'application/javascript; charset=utf-8', {
    ...
    'x-hapcapex-functional': 'v40.0.77',
