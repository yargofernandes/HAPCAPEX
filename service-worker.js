const CACHE_NAME = 'hapcapex-v40-0-82-retroactive-managerial-classification-20260910';
const APP_SHELL = [
  './',
  './index.html',
  './controle-capex.html',
  ...
  './v40-control-managerial.js?v=40.0.82',
...
const CONTROL_MANAGERIAL_TAG = '<script src="./v40-control-managerial.js?v=40.0.82"></script>';
